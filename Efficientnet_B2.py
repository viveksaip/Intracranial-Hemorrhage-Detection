# -*- coding: utf-8 -*-
"""Keras EfficientNet B2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1lNzmYLBaGXzZMkeKjipO7XCUKmny4Ls0
"""
...
"""Install and import the efficientnet and iterative-stratification packages from the internet."""
...
plt.ylabel('accuracy')
plt.xlabel('epochs')
plt.legend(labels = ["Training accuracy", "Validation accuracy"], fancybox=True, shadow=True, loc = "lower right")
...
plt.ylabel('loss')
plt.xlabel('epochs')
plt.legend(labels = ["Training loss", "Validation loss"], fancybox=True, shadow=True, loc = "upper right")